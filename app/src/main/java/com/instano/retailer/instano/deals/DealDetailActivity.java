...
public class DealDetailActivity extends GlobalMenuActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            int intExtra = getIntent().getIntExtra(DealDetailFragment.ARG_ITEM_ID, -1);
            DealDetailFragment fragment = DealDetailFragment.create(intExtra);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            ...
            //
            navigateUpTo(new Intent(this, DealListActivity.class));
            return true;
        }
