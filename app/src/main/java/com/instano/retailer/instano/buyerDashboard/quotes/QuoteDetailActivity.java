...
public class QuoteDetailActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            arguments.putString(QuoteDetailFragment.ARG_ITEM_ID,
                    getIntent().getStringExtra(QuoteDetailFragment.ARG_ITEM_ID));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            ...
            //
            navigateUpTo(new Intent(this, QuoteListActivity.class));
            return true;
        }
